      ...
      <div className="grid auto-rows-min gap-4 grid-cols-1 md:grid-cols-4 sm:grid-cols-2">
          ...
          <ScrollArea className="w-full whitespace-nowrap">
            <div className="flex w-max space-x-4 p-4 pb-5">
              {listenNowAlbums.map((album, index) =>
                <BlurFade key={`trend-${album.name}-${index}`} delay={0.15 + ((index % 4) * 0.05)} inView={index !== 1}>
        ...
        <div className="col-span-full">
          ...
          <div className="flex justify-center max-w-fit pt-4">
            ...
            >
              ...
              <CarouselContent>
                {listenNowAlbums.map((album, index) =>
                  <CarouselItem key={`category-${album.name}-${index}`} className="basis-1/2 md:basis-1/3 lg:basis-1/4 xl:basis-1/5">
                    <BlurFade delay={0.15 + ((index % 4) * 0.05)} inView>
        ...
        <div className="col-span-full">
          ...
          <ScrollArea className="w-full whitespace-nowrap">
            <div className="flex w-max space-x-4 p-4 pb-5">
              {listenNowAlbums.map((album, index) =>
                <BlurFade key={`trend-${album.name}-${index}`} delay={0.15 + ((index % 4) * 0.05)} inView>
                  <Link href="/mysteries/1" className="block space-y-3 cursor-pointer transition-all hover:scale-105">
                    <div className="overflow-hidden rounded-md">
                      <Image
                        src={album.cover}
