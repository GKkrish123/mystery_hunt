...
export const LikeButton = ({
  ...
  const isLiked = mockLike;

  return (
    <div
      className={cn("like-btn-container", className, isLiked ? "liked" : "")}
    >
      <AnimatePresence>
        <motion.button
          whileTap="tap"
          ...
          type="button"
          className="like-btn bg-slate-200 fill-slate-400 dark:bg-zinc-800 dark:fill-zinc-500"
        >
          {isLiked && (
            <svg
