...
export default function SplitText({
  ...
  return (
    <div
      className={cn(
        "relative mx-auto cursor-help text-4xl font-black uppercase text-yellow-500 md:text-5xl lg:text-9xl",
        className,
      )}
    >
      ...
      <div className="absolute top-0 flex h-full">
        {text.split("").map((letter, index) => (
          <div
            ...
            key={index}
            className="relative inline-flex h-full cursor-help flex-col leading-none"
          >
            {/** top half */}
            <span
            ...
            >
              <span className="absolute -translate-y-[55%] leading-none">
                {letter}
              </span>
            </span>
          </div>
